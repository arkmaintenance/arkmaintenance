...
import { Plus, Loader2, X, Link2, MapPin, Trash2 } from 'lucide-react'
...
export function AddQuotationDialog({ clients }: AddQuotationDialogProps) {
  ...
  const quoteNumber = `Q-${Math.floor(5000 + Math.random() * 1000)}`
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <Button type="button" variant="ghost" size="sm" className="text-[#00BCD4] text-xs h-6">
                + Add template
              </Button>
            </div>
            <Textarea
              ...
              placeholder="Scope of work... select a template or type manually"
