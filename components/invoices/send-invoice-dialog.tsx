...
export function SendInvoiceDialog({
  ...
  const [subject, setSubject] = useState(
    `Invoice ${invoiceData.invoice_number} from ARK Maintenance`
  )
  ...
  useEffect(() => {
    if (open) {
      ...
      setPdfBase64(null)
      setPdfError(null)
      setRecipientEmail(clientEmail || invoiceData.client.email || '')
    }
  }, [open, clientEmail, invoiceData.client.email])
  ...
  const emailPreviewHtml = generateInvoiceEmailHtml(invoiceData, personalMessage)
