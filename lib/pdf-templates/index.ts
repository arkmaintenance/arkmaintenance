// Legacy HTML templates (for preview only)
export { generateInvoicePdfHtml } from './invoice-pdf-template'
export { generateQuotationPdfHtml } from './quotation-pdf-template'
