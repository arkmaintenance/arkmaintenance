...
export default function QuotationPreviewPage() {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        notes: JSON.stringify({
          ...
          scope_of_work_points: values.scopeOfWorkPoints,
  ...
  const quotationData = {
    ...
    po_number: activeValues?.poNumber || '',
    trn: activeValues?.trn || '',
    ...
    warranty: activeValues?.warranty || '30 days',
    scopeTemplate: activeValues?.scopeTemplate || '',
    scopeOfWork: activeValues?.scopeOfWork || '',
    scopeOfWorkPoints: activeValues?.scopeOfWorkPoints || [],
    client: {
      name: activeValues?.contactPerson || quotation.clients?.contact_name || 'Client',
      company: activeValues?.selectedClientId || quotation.clients?.company_name || '',
